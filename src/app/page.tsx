...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      testimonials={[
        {
          ...
          testimonial: "The best North Indian food in Banjara Hills. The rooftop setting is just magical.",
          rating: 5,
        ...
        },
        {
          name: "Vikram Sethi",
          handle: "@vikram_dines",
          testimonial: "Exceptional service and the butter chicken is to die for. Definitely coming back.",
          rating: 5,
        ...
        },
        {
          name: "Priya Sharma",
          handle: "@priya_sharma",
          testimonial: "Stunning ambience for dinner with friends. Loved the kebabs!",
          rating: 4,
        ...
        },
        {
          name: "Arjun Rao",
          handle: "@arjun_rao",
          testimonial: "A truly sophisticated dining experience under the stars.",
          rating: 5,
        ...
        },
        {
          name: "Sneha K.",
          handle: "@sneha_k",
          testimonial: "Great staff and even better food. Highly recommended.",
          rating: 5,
      ...
      avatars={[
        {
          src: "http://img.b2bpic.net/free-photo/portrait-positive-young-man-holding-glass-wine_23-2148454112.jpg",
          alt: "Ananya Reddy",
        },
        {
        ...
        {
          src: "http://img.b2bpic.net/free-photo/portrait-young-woman-looking-away_23-2148454177.jpg",
          alt: "Arjun Rao",
        },
        {
          src: "http://img.b2bpic.net/free-photo/beautiful-blonde-woman-evening-dress-posing-holding-wine-glass_176420-3786.jpg",
          alt: "Sneha K",
        },
      ]}
    />
      ...
      bulletPoints={[
        {
          ...
          description: "Authentic flavors crafted by our expert chefs using time-honored techniques.",
        },
        {
          title: "Rooftop Oasis",
          description: "Dine under the stars in our lush, meticulously curated rooftop garden.",
        },
        {
          title: "Impeccable Service",
          description: "Warm, attentive hospitality designed to make every visit memorable.",
        },
      ]}
      ...
      features={[
        {
          ...
          description: "Enjoy unmatched views of Banjara Hills while you enjoy your meal.",
        ...
        },
        {
          ...
          description: "A curated menu featuring the finest dishes from the North of India.",
        ...
        },
        {
          ...
          description: "Perfect for romantic dinners, family gatherings, or formal meetings.",
          imageSrc: "http://img.b2bpic.net/free-photo/table-set-dinning-table_1339-3472.jpg",
        },
      ]}
  ...
  <div id="products" data-section="products">
      ...
      products={[
        ...
        },
        {
          ...
          name: "Paneer Tikka",
          price: "₹550",
          imageSrc: "http://img.b2bpic.net/free-photo/traditional-homemade-round-fresh-baked-breads-basket_23-2147975212.jpg",
        },
        {
          id: "p4",
          name: "Gosht Dum Biryani",
          price: "₹850",
          imageSrc: "http://img.b2bpic.net/free-photo/curry-with-chicken-onions-indian-food-asian-cuisine_2829-6270.jpg",
        },
        {
          id: "p5",
        ...
        },
        {
          ...
          name: "Gulab Jamun",
          price: "₹250",
          imageSrc: "http://img.b2bpic.net/free-photo/oven-baked-meat-casserole-with-sauce_140725-1066.jpg",
        },
      ]}
      ...
      testimonials={[
        {
          ...
          name: "Rahul Verma",
          role: "Food Critic",
          testimonial: "The balance of spices is perfection.",
        ...
        },
        {
          ...
          name: "Sonia Mehta",
          role: "Regular Guest",
          testimonial: "Always a pleasure dining here.",
        ...
        },
        {
          ...
          testimonial: "Excellent environment for meetings.",
        ...
        },
        {
          ...
          testimonial: "Loved the anniversary surprise!",
          imageSrc: "http://img.b2bpic.net/free-photo/pretty-woman-portrait_1303-11838.jpg",
        },
        {
          id: "t5",
          name: "Arjun D.",
          role: "Frequent Visitor",
          testimonial: "Simply the best kebabs in Hyderabad.",
  ...
  <div id="metrics" data-section="metrics">
      ...
      metrics={[
        ...
        },
        {
          id: "m3",
          value: "5th",
          description: "Floor View Excellence",
        },
      ]}
      ...
      faqs={[
        {
          ...
          content: "Yes, we strongly recommend reserving a table, especially on weekends.",
        },
        {
          id: "q2",
          title: "Is the restaurant wheelchair accessible?",
          content: "Yes, our premises are fully accessible to ensure a comfortable visit for everyone.",
        },
        {
          id: "q3",
          title: "What are your operating hours?",
          content: "We are open from 12 PM to 11 PM daily.",
        },
      ]}
  ...
  <div id="contact" data-section="contact">
      ...
      buttons={[
        {
          text: "Call Now: 096521 15500",
          href: "tel:09652115500",
        },
        {
          text: "Book Table Online",
